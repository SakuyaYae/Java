...
public class Run {
    public static void main(String[] args) {
        ...
        Soldier dark = new Soldier_builder().Name("Garo").Health(400).Age(29).Weapon(dark_steel_sword).build();
        Soldier empress = new Soldier_builder().Name("Sanaki").Health(2847).Age(20).Weapon(katana_darkness).build();
        Soldier sakura = new Soldier_builder().Name("Sakuya").Health(44000000).Age(4444).Weapon(sakura_blossom).build();
        ...
        System.out.println(String.format("%s %d, %d %s", dark.getName(), dark.getHealth(), dark.getAge(), dark.getWeapon().toString()));
        System.out.println("");
        System.out.println(String.format("%s %d, %d %s", empress.getName(), empress.getHealth(), empress.getAge(), empress.getWeapon().toString()));
        System.out.println("");
        System.out.println(String.format("%s %d, %d %s", sakura.getName(), sakura.getHealth(), sakura.getAge(), sakura.getWeapon().toString() ));        
    }
}
