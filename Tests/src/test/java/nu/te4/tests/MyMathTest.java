...
public class MyMathTest {
  ...
  @Test
    public void testDifference_int_int_reve() {
        System.out.println("difference");
        int a = 2;
        int b = 4;
        MyMath instance = new MyMath();
    ...
    public void testDifference_String_String() {
     ...
     @Test
    public void testDifference_String_String_reve() {
        System.out.println("difference");
        String a = "4";
        String b = "2";
        MyMath instance = new MyMath();
        ...
        @Test
    public void testDifrrence_Exception(){
        System.out.println("add exceptions");
        exception.expect(NumberFormatException.class);
        exception.expectMessage("Du måste ha siffror");
        String a = "fyra";
